...
#define ARM_GICR_TYPER_DPGS                                                    \
  (1 << 5)                                            // Disable Processor Group
                                                      // Selection Support
...
#define ARM_GICR_TYPER_GET_AFFINITY(TypeReg)                                   \
  (((TypeReg)&ARM_GICR_TYPER_AFFINITY) >> 32)
...
UINTN
EFIAPI
ArmGicGetInterfaceIdentification(IN INTN GicInterruptInterfaceBase);

// GIC Secure interfaces
VOID EFIAPI ArmGicSetupNonSecure(IN UINTN MpId, IN INTN GicDistributorBase,
...
VOID EFIAPI ArmGicSendSgiTo(IN INTN GicDistributorBase,
                            IN INTN TargetListFilter, IN INTN CPUTargetList,
                            IN INTN SgiId);
...
UINTN
EFIAPI
ArmGicAcknowledgeInterrupt(IN UINTN GicInterruptInterfaceBase,
...
UINTN
EFIAPI
ArmGicSetPriorityMask(IN INTN GicInterruptInterfaceBase, IN INTN PriorityMask);
...
BOOLEAN
EFIAPI
ArmGicIsInterruptEnabled(IN UINTN GicDistributorBase,
...
VOID EFIAPI ArmGicV2SetupNonSecure(IN UINTN MpId, IN INTN GicDistributorBase,
                                   IN INTN GicInterruptInterfaceBase);

VOID EFIAPI ArmGicV2EnableInterruptInterface(IN INTN GicInterruptInterfaceBase);

VOID EFIAPI
ArmGicV2DisableInterruptInterface(IN INTN GicInterruptInterfaceBase);
...
UINT32
EFIAPI
ArmGicV3GetControlSystemRegisterEnable(VOID);

VOID EFIAPI
ArmGicV3SetControlSystemRegisterEnable(IN UINT32 ControlSystemRegisterEnable);
...
UINTN
EFIAPI
ArmGicV3AcknowledgeInterrupt(VOID);
